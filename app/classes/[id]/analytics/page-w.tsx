    ...
    const fetchData = async () => {
      ...
      try {
        const [classRes, analyticsRes] = await Promise.all([
          apiRequest(`/classes/${classId}?school_id=${currentSchoolId}`),
          apiRequest(`/analytics/class/${classId}?timeRange=${timeRange}`)
        ]);
        ...
        toast({
          ...
          description: "Could not retrieve analytics for this class.",
          variant: "destructive",
        })
      } finally {
        setIsLoading(false)
      ...
      <Tabs defaultValue="overview" value={activeTab} onValueChange={setActiveTab} className="w-full">
        ...
        <TabsContent value="students" className="space-y-4 pt-4">
          <Card>
            ...
            <CardContent>
              <div className="h-[400px]">
                <PerformanceChart title="" description="" timeRange={timeRange} classId={classId} />
              </div>
            </CardContent>
          </Card>
