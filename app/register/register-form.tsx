...
export default function RegisterForm() {
  ...
  useEffect(() => {
    ...
    if (refId) {
      ...
      toast({
        title: "Uyarı",
        description: "Bu sayfa sadece bir elçi davet linki ile kullanılabilir.",
        variant: "destructive",
      })
    }
  }, [searchParams])
    ...
    try {
      if (activeTab === "user") {
        ...
        toast({
          ...
          description: "Kullanıcı hesabı oluşturuldu. Giriş sayfasına yönlendiriliyorsunuz.",
        ...
        toast({
          ...
          description: `${studentFormData.studentName} başarıyla sisteme eklendi.`,
          className: "bg-green-100 text-green-800",
        })
        // Formu temizle
    ...
    <div className="flex items-center justify-center min-h-screen bg-gray-50 p-4">
      <Card className="w-full max-w-md shadow-lg">
        <CardHeader className="text-center">
          ...
          <CardDescription>
            {ambassadorId
              ? `Elçi ${ambassadorId} aracılığıyla yeni bir kayıt oluşturun.`
              : "Geçerli bir davet linki gerekli."}
          </CardDescription>
        </CardHeader>
        <CardContent>
            ...
            <TabsContent value="user" className="pt-4">
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <Select
                    onValueChange={(value) =>
                      setUserFormData((prev) => ({ ...prev, role: value as "teacher" | "school_administrator" }))
                    }
        ...
        <CardFooter>
          <p className="text-xs text-gray-500 text-center w-full">
            KVKK ve FERPA gereği, öğrenci kişisel verileri sunucularımızda saklanmaz.
          </p>
        </CardFooter>
      </Card>
    </div>
