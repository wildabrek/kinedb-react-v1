...
import {apiRequest, createDevelopmentArea} from "@/lib/api"
...
export default function NewAreaPage() {
 ...
 return (
   <div className="container mx-auto py-6 space-y-6">
     ...
     <div className="flex items-center gap-2">
       ...
       <h1 className="text-2xl font-bold">Create New Area</h1>
     </div>

     <Card>
       <CardHeader>
         <CardTitle>Area Information</CardTitle>
         <CardDescription>Enter area details and settings</CardDescription>
       </CardHeader>
 ...
 function updateArea(key: string, value: string) {
   setArea((prev) => ({
     ...prev,
     [key]: value,
   }))
